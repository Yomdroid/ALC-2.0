...
public class Human3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_human3);
...
//        findViewById(R.id.logo).startAnimation(logoAnim);
        ...
        first = intent.getStringExtra("firstplayer");
        second = intent.getStringExtra("secondplayer");
        ...
        playerOne.setText(first);
        playerTwo.setText(second);
    ...
    void playerPlay() {
        ...
        String playing = first + "'s turn";
        playe = 1;
        playerSign = playerOneSign;

        if (playerTwoTurn) {
            playing = second + "'s turn";
